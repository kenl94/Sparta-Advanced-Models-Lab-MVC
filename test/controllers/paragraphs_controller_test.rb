...
class ParagraphsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paragraph" do
    assert_difference('Paragraph.count') do
      post paragraphs_url, params: { paragraph: { body: @paragraph.body, chapter_id: @paragraph.chapter_id } }
    end
  ...
  test "should update paragraph" do
    patch paragraph_url(@paragraph), params: { paragraph: { body: @paragraph.body, chapter_id: @paragraph.chapter_id } }
